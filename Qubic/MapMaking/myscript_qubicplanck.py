...
mp.figure(3)
mp.clf()
display(convolved_sky, 'Original map', iplot=1, reso=reso, xsize=xsize)
display(solution_fusion['x'], 'Reconstructed map', iplot=4,reso=reso, xsize=xsize)
Trange=[1,1,1]
res_fusion = display(solution_fusion['x'] - convolved_sky,
                     'Difference map', iplot=7, reso=reso, Trange=Trange, xsize=xsize)
