...
ext='.db'
repfig = '/Users/hamilton/SDSS/LymanAlpha/JCMC_Chains/March2014/'
######################## Ok ################################
model='olambdacdm'
bao_hrp_obh2p1=mcmc.readchains(rep+model+'-'+'BAO_HRiessPlanck_obh2BBN'+ext,add_extra=True)
lya_bao_hrp_obh2p1=mcmc.readchains(rep+model+'-'+'LyaDR11_BAO_HRiessPlanck_obh2BBN'+ext,add_extra=True)
lya_hrp_obh2p1=mcmc.readchains(rep+model+'-'+'LyaDR11_HRiessPlanck_obh2BBN'+ext,add_extra=True)
...
axis('off')
legend([a2],['BAO Lyman-alpha + h Riess/Planck + Obh2 BBN'],title=model)
...
legend([a2],['BAO Lyman-alpha + h Riess/Planck + $\Omega_b h^2$ BBN'],frameon=False)
...
a1=mcmc.matrixplot(bao_hrp_obh2p1,vars,'green',2,limits=limits,alpha=0.5)
a2=mcmc.matrixplot(lya_bao_hrp_obh2p1,vars,'red',2,limits=limits,alpha=0.5)
subplot(2,2,2)
axis('off')
...
plot(xx*0+omplanckwp,2*xx,'k:')
plot(xx,xx*0+1-omplanckwp,'k:')
a0=mcmc.cont(lya_hrp_obh2p1['omega_M_0'],lya_hrp_obh2p1['omega_lambda_0'],nsmooth=5,color='blue',alpha=0.5)
a1=mcmc.cont(bao_hrp_obh2p1['omega_M_0'],bao_hrp_obh2p1['omega_lambda_0'],nsmooth=5,color='green',alpha=0.5)
a2=mcmc.cont(lya_bao_hrp_obh2p1['omega_M_0'],lya_bao_hrp_obh2p1['omega_lambda_0'],nsmooth=5,color='red',alpha=0.5)
...
a0=mcmc.matrixplot(lya_hrp_obh2p1,vars,'blue',3,limits=limits,alpha=0.5)
a1=mcmc.matrixplot(bao_hrp_obh2p1,vars,'green',5,limits=limits,alpha=0.5)
a2=mcmc.matrixplot(lya_bao_hrp_obh2p1,vars,'red',5,limits=limits,alpha=0.5)
subplot(2,2,2)
axis('off')
legend([a0,a1,a2],['BAO Lyman-alpha + h + $\Omega_b h^2$',
                   'BAO LRG + h + $\Omega_b h^2$',
...
omplanckwp=0.3183
clf()
a2=mcmc.cont(lya_hrp_obh2p1['omega_M_0'],lya_hrp_obh2p1['w'],alpha=0.7,nsmooth=2)
xx=linspace(0,1,100)
plot(xx,xx*0-1,'k:')
plot(xx*0+omplanckwp,-2*xx,'k:')
...
plot(xx,xx*0-1,'k:')
plot(xx*0+omplanckwp,-2*xx,'k:')
a0=mcmc.cont(lya_hrp_obh2p1['omega_M_0'],lya_hrp_obh2p1['w'],alpha=0.5,color='blue',nsmooth=5)
a1=mcmc.cont(bao_hrp_obh2p1['omega_M_0'],bao_hrp_obh2p1['w'],alpha=0.5,color='green',nsmooth=5)
a2=mcmc.cont(lya_bao_hrp_obh2p1['omega_M_0'],lya_bao_hrp_obh2p1['w'],alpha=0.5,color='red',nsmooth=5)
xx=linspace(0,1,100)
...
a0=mcmc.matrixplot(lya_hrp_obh2p1,vars,'blue',2,limits=limits,alpha=0.5)
...
a2=mcmc.matrixplot(lya_hrp_obh2p1,vars,'blue',2.,limits=limits,alpha=alpha,labels=labels)
subplot(len(vars),len(vars),len(vars))
axis('off')
legend([a2],[ 'BAO Lyman-alpha + h Riess/Planck + $\Omega_b h^2$ BBN'],title=model)
subplot(3,3,4)
xx=linspace(0,1,100)
plot(xx,xx*0+1-omplanckwp,'k:')
...
vars=['omega_M_0','omega_lambda_0','w']
labels=['$\Omega_M$','$\Omega_\Lambda$','$w$']
a0=mcmc.matrixplot(lya_hrp_obh2p1,vars,'blue',2,limits=limits,alpha=alpha,labels=labels)
a1=mcmc.matrixplot(bao_hrp_obh2p1,vars,'green',4,limits=limits,alpha=alpha,labels=labels)
a2=mcmc.matrixplot(lya_bao_hrp_obh2p1,vars,'red',2,limits=limits,alpha=alpha,labels=labels)
subplot(len(vars),len(vars),len(vars))
axis('off')
legend([a0,a1,a2],['BAO Lyman-alpha + h + $\Omega_b h^2$',
                   'BAO LRG + h + $\Omega_b h^2$',
