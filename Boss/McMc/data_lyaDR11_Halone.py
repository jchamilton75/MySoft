...
proba_invhrs=proba.sum(axis=1)
proba_invhrs=proba_invhrs/(proba_invhrs.sum()*newdx)

#clf()
#plot(X_hrs,proba_invhrs)
#############################################################################


######### interpolating function ############################################
likelihood_interp=scipy.interpolate.interp1d(X_hrs,proba_invhrs,copy=True,bounds_error=False,fill_value=0.)
#############################################################################
